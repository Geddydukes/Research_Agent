...
describe('Entity deduplication and batch operations', () => {
  ...
  it('batches node lookups instead of N+1 queries', async () => {
    ...
    (mockDb.insertNodes as jest.MockedFunction<DatabaseClient['insertNodes']>).mockResolvedValue([
      { id: 2, tenant_id: TEST_TENANT_ID, canonical_name: 'entity_b', type: 'Entity', metadata: null, original_confidence: null, adjusted_confidence: null, review_status: 'approved', review_reasons: null, created_at: '2024-01-01' },
      { id: 3, tenant_id: TEST_TENANT_ID, canonical_name: 'entity_c', type: 'Method', metadata: null, original_confidence: null, adjusted_confidence: null, review_status: 'approved', review_reasons: null, created_at: '2024-01-01' },
    ]);
